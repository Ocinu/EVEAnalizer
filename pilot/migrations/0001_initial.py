    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("eve_id", models.BigIntegerField(db_index=True, unique=True)),
                (
                    "name",
                    models.CharField(blank=True, default="Unnamed", max_length=250),
                ),
                (
                    "solar_system",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("range", models.CharField(blank=True, max_length=250, null=True)),
